...
class ReminderModelService:
    ...
    @staticmethod
    def create(
        reminder_attrs: ReminderModelInterface, app: Flask, db: SQLAlchemy
    ) -> ReminderModel:
        """
    ...
    def update(
        ...
        updates: ReminderModelInterface,
        app: Flask,
        db: SQLAlchemy,
    ) -> ReminderModel:
        """
...
class RemindersTimeSlotModelService:
    ...
    @staticmethod
    def create(
        time_slot_attrs: RemindersTimeSlotModelInterface, app: Flask, db: SQLAlchemy
    ) -> RemindersTimeSlotModel:
        """
        CREATE
    ...
    @staticmethod
    def update(
        time_slot: RemindersTimeSlotModel,
        updates: RemindersTimeSlotModelInterface,
        app: Flask,
        db: SQLAlchemy,
    ) -> RemindersTimeSlotModel:
        """
    ...
    def delete_all_by_reminder_id(reminder_id: int, app: Flask, db: SQLAlchemy):
        ...
        if app.config["DEBUG"] or app.config["TESTING"]:
            ...
            for (
                time_slot
            ) in RemindersTimeSlotModelService.retrieve_slots_by_reminder_id(
                reminder_id, app
            ):
    ...
    @staticmethod
    def retrieve_slots_by_reminder_id(
        reminder_id: int, app: Flask
    ) -> List[RemindersTimeSlotModel]:
        """
        RETREIVE
